  ...
  return (
    <div style={{ display:'flex', height:'100vh', overflow:'hidden', position:'relative' }}>
      ...
      <main className="app-main" style={{ flex:1, overflowY:'auto', background:'#f0f2f7', minWidth:0 }}>
        ...
        <div className="main-pad" style={{ maxWidth: tab==='pipeline' ? 1200 : 1100, margin:'0 auto', padding:'24px 28px', animation:'fadeUp .22s ease both' }} key={tab}>
          ...
          {tab==='outreach' && <OutreachPage key={`outreach-${cvContext.jd}-${cvContext.cand}`} user={user} aiConfig={aiConfig} store={store} onStoreChange={handleStoreChange} onNavigate={navigate} notify={notify} preselectedJD={cvContext.jd} preselectedCand={cvContext.cand} />}
